...
void loop()
{
    ...
    if ( flag01 == 1 ) {
      ...
      //  Вывод на катоды f50a
      digitalWrite(f50a, f50sost);
      f50sost = !f50sost;
      digitalWrite(f50b, f50sost);
          ...
          if ( dessec > 5 ) {
            ...
            if ( edmin > 9 ) {
              ...
              if ( desmin >5 ) {
                ...
                //  в начале дня константа
                if ( ( ( deschas * 10 )+edchas) < 1 ) {
                  OCR1A = h_OCR1A;    //  Длинная конст - медленнее ходят
                }
                //  во второй пол дня константа
                //if ( ( ( deschas * 10 )+edchas) > 18 ) {
                  //OCR1A = l_OCR1A;    //  Короткая конст - быстрее ходят
                //}
